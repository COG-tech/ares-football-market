...
def build_templates() -> None:
    profile_body = """<div class="ares-profile-beta-badge">Public Beta Demo</div><section class="ares-profile-hero"><div class="ares-player-media-card"><div class="ares-shirt-number">9</div><div id="player-photo" class="ares-profile-photo">AR</div></div><div class="ares-player-core-card"><div class="ares-player-title-row"><div><h1 id="player-name">Player Profile</h1><p><span id="club"></span><span class="ares-profile-separator">|</span><span id="country"></span></p></div><span class="ares-verified-dot" aria-label="Verified demo profile"></span></div><div class="ares-player-facts"><div><span>Age</span><strong id="age"></strong><small id="date-of-birth"></small></div><div><span>Height</span><strong id="height">Source review</strong></div><div><span>Foot</span><strong id="foot"></strong></div><div><span>Position</span><strong id="position"></strong><small id="role"></small></div></div><div class="ares-contract-strip"><div><span>Contract until</span><strong id="contract-end"></strong></div><div><span>Joined</span><strong id="joined">Source review</strong></div><div><span>Agent</span><strong id="agent">Source review</strong></div><div><span>Outfitter</span><strong id="outfitter">Source review</strong></div></div></div><div class="ares-player-score-deck"><div class="ares-score-card"><span>ARES Score</span><strong id="ares-score"></strong><small id="ares-tier"></small><i class="ares-score-ring" aria-hidden="true"></i></div><div class="ares-score-card"><span>Market Score</span><strong id="market-score"></strong><small id="market-tier"></small><i class="ares-score-ring" aria-hidden="true"></i></div><div class="ares-score-card"><span>Transfer Value Signal</span><strong id="transfer-value-signal"></strong><small id="trend"></small></div><div class="ares-score-card"><span>Data Confidence</span><strong id="confidence"></strong><small>&gt; 95% data coverage</small></div></div><div class="ares-player-actions"><a class="ares-action-button" href="../watchlist/">* Watchlist</a><a class="ares-action-button" href="../players/">&lt;-&gt; Compare</a><a id="player-roster-link" class="ares-action-button" href="#" hidden>+ Club Fit</a><a class="ares-action-button is-light" href="../methodology.html">i Methodology</a></div></section><section id="player-view-note" class="ares-player-tab-panel"><h2 class="h4">Overview</h2><p>Player intelligence view will render from the selected profile record.</p></section><section class="ares-profile-source-card"><h2 class="h4">Image Source</h2><p>Source: <span id="photo-source"></span>. License: <span id="photo-license"></span>. Credit: <span id="photo-credit"></span>.</p></section><section id="profile-message" class="ares-section ares-card" hidden></section>"""
