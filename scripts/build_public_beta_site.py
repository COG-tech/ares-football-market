...
required_leagues = [
    ...
    ("Liga de Expansión MX", "Mexico", "North America", 2),
...
transfers = [
    ...
    transfer_row(2, players[7], "Academy Select", "Monterra Azul", "Liga de Expansión MX", "Liga MX", "Promotion", 1.1, 4.1, "Low"),
...
def status_section(prefix: str = "") -> str:
    ...
    </div><p class="ares-beta-note">Public Beta Demo rows are fictional seeded records that show the product experience before approved live football data is connected.</p></section>'''
...
def table_html(table_id: str, body_id: str, count_id: str, headers: list[str], empty: str = "Public Beta Demo rows are unavailable.") -> str:
...
def beta_badge() -> str:
    return '<span class="ares-beta-badge">Public Beta Demo</span>'
